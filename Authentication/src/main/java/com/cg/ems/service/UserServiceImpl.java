...
import com.cg.ems.model.Role;
import com.cg.ems.model.User;
import com.cg.ems.repository.UserRepository;
...
public class UserServiceImpl implements UserService{
	...
	public User save(UserRegistrationDto registrationDto) {
		User user = new User(registrationDto.getUserName(), 
				passwordEncoder.encode(registrationDto.getUserPassword()), registrationDto.getUserType(),Arrays.asList(new Role("ROLE_USER")));
