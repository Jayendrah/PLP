...
public class EmployeeController {
	...
	public ResponseEntity<Employee> addEmployee( @RequestBody Employee employee) throws EmployeeAlreadyExsistsException{
	...
	@PutMapping("empFirstName/{empId}/{empFirstName}")
	public ResponseEntity<String> updatempFirstNameByEmpId( @Valid @PathVariable("empId") Integer empId,@PathVariable("empFirstName") String empFirstName) throws EmployeeNotFoundException{
	...
	@PutMapping("empLastName/{empId}/{empLastName}")
	...
	@PutMapping("empGrade/{empId}/{empGrade}")
	...
	@PutMapping("designation/{empId}/{designation}")
	...
	@PutMapping("maritalStatus/{empId}/{maritalStatus}")
